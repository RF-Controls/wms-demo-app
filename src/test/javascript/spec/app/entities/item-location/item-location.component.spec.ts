...
import { ItemLocationComponent } from 'app/entities/item-location/item-location.component';
...
describe('Component Tests', () => {
  describe('ItemLocation Management Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ItemLocationComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.itemLocations && comp.itemLocations[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
